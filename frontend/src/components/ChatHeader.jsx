          ...
          <div>
            <div className="dropdown dropdown-start z-10 w-fit">
              ...
              {selectedUser._id !== authUser._id &&
                <div tabIndex={0} className="dropdown-content menu bg-base-300 z-1 w-64 p-2 shadow-sm rounded-md">

                  <div className="relative flex items-center justify-center w-full aspect-square overflow-hidden rounded-md">
                    {selectedUser.profilePicture ?
                  ...
                  <h1 className='text-xl mt-1'>{selectedUser.fullName}</h1>
                  {selectedUser.bio && <p>Bio: ${selectedUser.bio}</p>}

                  <hr className='border-zinc-500 my-1 opacity-50' />
